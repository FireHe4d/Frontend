...
function Auth() {
    ...
    const sendRequest = (path) => {
        PostWithoutAuth(("/auth/"+path), {
          ...
          .then((res) => res.json())
          .then((result) => {
            if(result.accessToken!=undefined&&result.refreshToken!=undefined&&result.userId!=undefined){
...
<Button variant = "contained"
            ...
            <FormHelperText style={{margin:20}}>Did not you register?</FormHelperText>
