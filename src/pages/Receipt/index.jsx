...
import Rece from '../../components/Receipt'
...
const Receipt = () => {
    ...
    const requests = {
        ...
        fetchReceipt:`/recept/${receipt_id}`,
    };
    ...
    useEffect(() => {
        ...
        async function fetchReceipt() {
            const data = await fetch(`${instance.baseURL}${requests.fetchReceipt}`);
            const res = await data.json();
            setReceipt(res);
        }
        fetchNations();
           ...
           "" }
            ...
            <div className='home_panelList-wrap'>
                ...
                <div className='home_list-wrap'>
                    {receipt_id ? <Rece list={receipt}  type_receipts={type_receipts} nations={nations} ingList={ingList}/> : <EmptyView />}
